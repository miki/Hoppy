# This Makefile is for the Hoppy extension to perl.
#
...
#     AUTHOR => q[Takeshi Miki <miki@cpan.org>]
#     DIR => []
#     DISTNAME => q[Hoppy]
#     NAME => q[Hoppy]
#     NO_META => q[1]
...
TO_INST_PM = lib/Hoppy.pm \
	lib/Hoppy/Base.pm \
	lib/Hoppy/Formatter/JSON.pm \
	lib/Hoppy/Room/Memory.pm \
	lib/Hoppy/Service/Base.pm \
	lib/Hoppy/Service/Login.pm \
	lib/Hoppy/Service/Logout.pm \
	lib/Hoppy/TCPHandler.pm \
	lib/Hoppy/TCPHandler/Connected.pm \
	lib/Hoppy/TCPHandler/Disconnected.pm \
	lib/Hoppy/TCPHandler/Error.pm \
	lib/Hoppy/TCPHandler/Input.pm \
	lib/Hoppy/TCPHandler/Send.pm \
	lib/Hoppy/User.pm

PM_TO_BLIB = lib/Hoppy/TCPHandler/Disconnected.pm \
	blib/lib/Hoppy/TCPHandler/Disconnected.pm \
	lib/Hoppy/Room/Memory.pm \
	blib/lib/Hoppy/Room/Memory.pm \
	lib/Hoppy/Service/Base.pm \
	blib/lib/Hoppy/Service/Base.pm \
	lib/Hoppy/Base.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Hoppy.pm $(INST_MAN3DIR)/Hoppy.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,00001,0,0">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <TITLE>$(DISTNAME)</TITLE>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT></ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Takeshi Miki &lt;miki@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Hoppy/TCPHandler/Disconnected.pm blib/lib/Hoppy/TCPHandler/Disconnected.pm \
	  lib/Hoppy/Room/Memory.pm blib/lib/Hoppy/Room/Memory.pm \
	  lib/Hoppy/Service/Base.pm blib/lib/Hoppy/Service/Base.pm \
	  lib/Hoppy/Base.pm blib/lib/Hoppy/Base.pm \
	  lib/Hoppy/TCPHandler/Input.pm blib/lib/Hoppy/TCPHandler/Input.pm \
	  lib/Hoppy/Formatter/JSON.pm blib/lib/Hoppy/Formatter/JSON.pm \
	  lib/Hoppy/TCPHandler/Send.pm blib/lib/Hoppy/TCPHandler/Send.pm \
	  lib/Hoppy/User.pm blib/lib/Hoppy/User.pm \
	  lib/Hoppy.pm blib/lib/Hoppy.pm \
